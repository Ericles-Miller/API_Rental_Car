...
let CreateSpecificationUseCase = class CreateSpecificationUseCase {
    constructor(specificationsRespository) {
    ...
    execute({ description, name }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const specificationAlreadyExists = yield this.specificationsRespository.findByName(name);
            if (specificationAlreadyExists) {
                throw new AppError_1.AppError('Specification already exists!', 401);
            }
            yield this.specificationsRespository.create({
                name,
                description,
            });
        });
