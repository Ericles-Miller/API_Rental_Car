...
let RefreshTokenUseCase = class RefreshTokenUseCase {
    constructor(usersTokensRepository, datejsProvider) {
        this.usersTokensRepository = usersTokensRepository;
        this.datejsProvider = datejsProvider;
    }
    execute(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const { email, sub } = (0, jsonwebtoken_1.verify)(token, auth_1.default.secret_refresh_token);
            const user_id = sub;
            const userToken = yield this.usersTokensRepository.findByUserIdAndToken(user_id, token);
            if (!userToken) {
                throw new AppError_1.AppError('Refresh token does not exists!');
            }
            yield this.usersTokensRepository.deleteById(userToken.id);
            const expires_date = this.datejsProvider.addDays(auth_1.default.expires_refresh_token_days);
            ...
            const newToken = (0, jsonwebtoken_1.sign)({}, auth_1.default.secret_token, {
                subject: user_id,
                expiresIn: auth_1.default.expires_in_token, // tempo para expirar relacionado ao export auth
            });
            return {
                refresh_token,
                token: newToken,
